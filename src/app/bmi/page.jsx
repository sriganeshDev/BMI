  ...
  const handleCalculate = async () => {
    ...
    try {
      const response = await axios.post(
        "https://bmi-backend-1-12ua.onrender.com/api/bmi",
        {
              ...
              "
                ...
                <div className="mt-4 w-full flex flex-col items-center space-y-4">
                  <p className="text-gray-800 text-sm  max-md:text-sm text-center">
                    Please verify your weight and details before clicking
                    Calculate.
                  </p>
                  <button
                    disabled={loading}
              ...
              <div className="w-full  lg:p-6 p-4   flex flex-col justify-center items-center rounded-2xl border-2 border-gray-200 lg:space-y-3 max-md:space-y-2 bg-white shadow-md">
                <div className="w-full space-y-6 max-md:space-y-2">
                  ...
                  <p className="text-sm max-md:text-sm text-gray-600">
                    Body Mass Index (BMI) is a simple screening tool that
                    estimates the amount of body fat based on height and weight.
                    It is used to categorize individuals into different weight
                    categories, such as underweight, normal weight, overweight,
                    or obese. Maintaining a BMI within a healthy range can help
                    reduce the risk of developing various health conditions.
                  </p>
                  ...
                  <p className="text-sm max-md:text-sm text-gray-600">
                    While BMI is a useful general indicator, it has limitations.
                    It does not differentiate between muscle, bone, and fat
                    mass, meaning that highly muscular individuals may be
                    misclassified as overweight or obese. BMI also may not
                    accurately reflect the health status of pregnant women,
                    young children, older adults, or certain ethnic groups.
                  </p>
                  ...
                  <p className="text-sm max-md:text-sm text-gray-600">
                    ...
                    provide your BMI value and show you which category it falls
                    into based on standard BMI ranges.
                  </p>
                  ...
                  <p className="text-sm max-md:text-sm text-gray-600">
                    ...
                    serious health conditions like type 2 diabetes, heart
                    disease, high blood pressure, and certain cancers. BMI is
                    often used by healthcare providers to assess whether further
                  ...
                  <ul className="list-disc list-inside text-sm max-md:text-sm text-gray-600 space-y-2">
                    ...
                    <li>
                      Stay hydrated and limit the intake of processed and
                      high-sugar foods.
                    </li>
                    <li>
